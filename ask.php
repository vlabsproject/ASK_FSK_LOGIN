...
<button id="toggle-btn" class="helpButton">Help</button>
<div id="my-div" style="display: none;">
            <span><img src="images/setup2.png" alt="" style="position:absolute;top:28rem;height: 80vh;"></span> 
</div>


<!-- <script src="scripts/ask.js"></script> -->
<script>
          <?php include "scripts/ask.js" ?>
    </script>
</body>
</html>